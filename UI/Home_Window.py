...
def Home():
    ...
    lblInfo1 = Label (frameHome, text = '''With us, you experience a lavish lifestyle for your travel 
                      duration and get to experience all basic and extravagant amenities under your budget! 
                      From inbuilt swimming pool to comfortable rooms/suites which gives you home-ly vibes and
                       from musical concerts twice a week to the most delightful dishes, we have everything 
                      that you’d want us to have, to provide, for you. ''', font = 'Times', wraplength = 275)
    ...
    lblInfo2 = Label(frameHome, text = '''Satisfying and serving guests with the best of everything and safety 
                     is our first priority. Choose Bermuda for your next vacay and cherish the memories life long! 
                     You are our Guest, You are our Family, You are served better, at Bermuda,''', 
                     font = 'Times', wraplength = 275)
...
def Info():
    ...
    lblGlobe = Label (frameInfo, text = '''Cruises with Bermuda Cruise unlock some of the best and most iconic corners 
                      of the world. With us, there’s no limit on adventure — whether you dream of island-hopping to 
                      beautiful beaches in the Caribbean and the South Pacific, exploring national parks in Alaska and 
                      northern Europe or immersing yourself in Asia’s many exotic wonders. No matter where you wander, 
                      you’re in for a getaway unlike any other.''', anchor = 'w', wraplength = 465)
    ...
    lblSeason = Label (frameInfo, text = '''Turn up the thrills like never before. Here, Bermuda Cruise puts adventure 
                       in the fast lane with shriek-inducing slides and rushing tides. Get your adrenaline fix zip lining 
                       across the sunny, blue sky. Have some fun at the casino where you can feel like you are in Las Vegas. 
                       Kids can enjoy their time at our gaming arcade. Max out your relaxation with endless ways to chill. 
                       Jam to DJ spun beats with a signature Coco Loco from the bustling swim-up bar at Oasis Lagoon. Wind 
                       down shore side in a private cabana at Chill Island.''', font = 'Times', wraplength = 465)
    ...
    lblCuisine = Label (frameInfo, text = '''Perfect Day at Bermuda Cruise offers loads of options to fuel up in between 
                        adventures. From mouth-watering Caribbean-style bites at Chill Grill to irresistible chicken 
                        sandwiches at Snack Shack, there’s plenty of complimentary delicious options everywhere you turn. 
                        Plus, discover even more ways to indulge at Coco Beach Club with elevated dishes like Bahamian 
                        lobster rolls, and grilled Caribbean grouper.''', font = 'Times', wraplength = 465)
    ...
    lblPricing = Label (frameInfo, text = '''Our staterooms are designed with every type of guest in mind. Whether you’re 
                        sailing with your significant other, your family, a group of friends, or traveling solo. Our Interior 
                        staterooms include a wide array of amenities for your whole family to enjoy. Savor the seaside and snapshots 
                        of landscapes from shore to shore. Claim your slice of paradise with balcony views just outside your door. 
                        Enjoy expansive accommodations that take luxury to the next level.''', font = 'Times', wraplength = 465)
